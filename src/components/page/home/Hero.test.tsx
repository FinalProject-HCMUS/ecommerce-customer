...
// Mock image import
jest.mock('../../../assets/images/hero/hero.png', () => 'mock-hero-img', {
  virtual: true,
});
...
describe('Hero', () => {
  ...
  it('renders all characteristics in rows of 3', () => {
    ...
    expect(
      screen.getByText('hero.characteristics.0.title')
    ).toBeInTheDocument();
    expect(
      screen.getByText('hero.characteristics.1.title')
    ).toBeInTheDocument();
    expect(
      screen.getByText('hero.characteristics.2.title')
    ).toBeInTheDocument();
    expect(
      screen.getByText('hero.characteristics.3.title')
    ).toBeInTheDocument();
    expect(
      screen.getByText('hero.characteristics.0.description')
    ).toBeInTheDocument();
    expect(
      screen.getByText('hero.characteristics.1.description')
    ).toBeInTheDocument();
    expect(
      screen.getByText('hero.characteristics.2.description')
    ).toBeInTheDocument();
    expect(
      screen.getByText('hero.characteristics.3.description')
    ).toBeInTheDocument();
  });
