...
jest.mock('../../../helpers/i18n', () => ({
  t: jest.fn((key: string) => {
    ...
    const translations: Record<string, string> = {
      ...
      'policy.0.content':
        'Our returns policy allows returns within 30 days of purchase.',
...
describe('PolicySection', () => {
  ...
  test('renders policy section with index 1', () => {
    ...
    expect(
      screen.getByText('We respect your privacy and protect your data.')
    ).toBeInTheDocument();
  });
  ...
  test('renders policy section with index 2', () => {
    ...
    expect(
      screen.getByText('By using our service, you agree to these terms.')
    ).toBeInTheDocument();
  });
