...
describe('ProfileImage Component', () => {
  ...
  test('renders with default props', () => {
    ...
    expect(screen.getByAltText('Profile')).toHaveAttribute('src', '/placeholder.svg');
    
    // Camera icon should not be visible when not editing
    expect(screen.queryByRole('img', { name: /camera/i })).not.toBeInTheDocument();
  });
  ...
  test('renders with provided image', () => {
    ...
    expect(screen.getByAltText('Profile')).toHaveAttribute('src', 'test-image.jpg');
  });
