...
jest.mock('../../components/page/auth/registration/RegistrationForm', () => ({
  __esModule: true,
  default: () => <div data-testid="mock-registration-form">Registration Form Component</div>,
}));
...
describe('Registration Page', () => {
  ...
  test('correctly positions ShopInfo and RegistrationForm components', () => {
    ...
    expect(children.indexOf(shopInfo)).toBeLessThan(children.indexOf(registrationForm));
  });
