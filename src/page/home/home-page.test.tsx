...
// Mock the components
jest.mock('../../components/page/home/Hero', () => () => (
  <div data-testid="hero-component">Hero Component</div>
));
jest.mock('../../components/page/home/Brands', () => () => (
  <div data-testid="brands-component">Brands Component</div>
));
jest.mock('../../components/page/home/Featured', () => () => (
  <div data-testid="featured-component">Featured Component</div>
));
jest.mock('../../components/page/home/Contact', () => () => (
  <div data-testid="contact-component">Contact Component</div>
));
jest.mock(
  '../../components/page/home/CommonProduct',
  () =>
...
describe('HomePage Component', () => {
  ...
  it('should render all components when data is loaded', async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByTestId(`common-product-lbl.topTrending`)
      ).toBeDefined();
    });
  ...
  it('should pass the correct data to CommonProducts components', async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByTestId(`common-product-count-lbl.topSelling`).textContent
      ).toBe('2');

      // Check that top trending products data is passed correctly
      expect(
        screen.getByTestId(`common-product-count-lbl.topTrending`).textContent
      ).toBe('2');
    });
  });
